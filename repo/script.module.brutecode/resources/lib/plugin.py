...
from brutecode import plugin, settings, gui
from brutecode.util import get_kodi_setting, get_addon, run_plugin

from .util import check_updates, get_brutecode_addons
...
def check_log(**kwargs):
    ...
    addon_ids = [x.lower() for x in get_brutecode_addons()]
