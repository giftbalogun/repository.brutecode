...
class Generator:
    ...
    def _generate_md5_file(self):
        try:
            ...
            tt = os.path.join(self.zips_path, "addons.xml")
            print(tt)
           
            m = hashlib.md5(open(os.path.join(self.zips_path, "addons.xml"), "r" ).read().encode('utf-8') ).hexdigest()
            # save file
    ...
    def _save_file( self, data, file ):
        try:
            ...
            open( file, "w", encoding='utf-8' ).write( str(data) )
            print("Done!")
        except Exception as e:
            # oops
