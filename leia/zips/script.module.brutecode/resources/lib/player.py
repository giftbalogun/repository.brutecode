...
from brutecode.util import get_kodi_string, set_kodi_string
from brutecode.log import log
from brutecode.router import add_url_args
from brutecode.monitor import monitor
...
class Player(xbmc.Player):
    ...
    def onAVStarted(self):
        ...
        play_skips = []
        up_next = get_kodi_string('_brutecode_play_next')
        if up_next:
            set_kodi_string('_brutecode_play_next')
        ...
        _skips = get_kodi_string('_brutecode_play_skips')
        if _skips:
            set_kodi_string('_brutecode_play_skips')
        ...
        callback = get_kodi_string('_brutecode_play_callback')
        if callback:
            set_kodi_string('_brutecode_play_callback')
